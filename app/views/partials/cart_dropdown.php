...
<div class="relative" id="cartDropdownContainer">
    <button id="cartToggleBtn" type="button" title="Keranjang" aria-label="Keranjang" class="relative inline-flex items-center justify-center gap-1.5 text-gray-600 hover:text-gray-800 text-sm rounded-lg hover:bg-gray-100 cursor-pointer w-10 h-10 sm:w-auto sm:h-auto sm:px-3 sm:py-2">
