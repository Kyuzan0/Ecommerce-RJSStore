...
<div id="bulk-action-bar" class="ds-bulkbar-wrap hidden" style="opacity:0; transition:opacity 0.2s">
    <div class="flex items-center justify-between sm:justify-start gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-2xl shadow-lg border border-gray-200 bg-white w-full sm:w-auto">
        <span class="text-xs sm:text-sm font-semibold text-gray-700 whitespace-nowrap"><span id="selected-count">0</span> transaksi dipilih</span>
        ...
        <table class="w-full text-sm">
            <thead class="bg-gray-50 border-b border-gray-100">
                <tr>
                    ...
                    <th class="px-5 py-1.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Info Transaksi</th>
                    <th class="px-5 py-1.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Produk</th>
                    <th class="px-5 py-1.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Harga</th>
                    <th class="px-5 py-1.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Tanggal</th>
                    <th class="px-5 py-1.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Status</th>
