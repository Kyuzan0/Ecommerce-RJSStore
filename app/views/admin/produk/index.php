            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-6 py-4">
                    <div class="flex items-center gap-1">
                        ...
                        <span class="text-sm font-semibold text-gray-700"><?= $r['avg_rating']; ?></span>
                        <span class="text-xs text-gray-400">(<?= $r['total_rating'] ?>)</span>
                    </div>
                </td>
                <td class="px-6 py-4"><a href="<?= url('/uploads/' . e($r['file_upload'])); ?>" target="_blank" class="text-sm font-medium hover:underline" style="color:#1976D2">Lihat File</a></td>
