...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-sm text-gray-500 mt-1">Varian: <span class="font-semibold"><?= e($varian_label) ?></span> — <?= rupiah($varian['harga']) ?></p>
    </div>
    ...
    <div class="lg:col-span-2">
        <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
            ...
            <div class="p-8 text-center">
                ...
                <p class="text-gray-500 text-sm">Belum ada stok. Tambahkan akun di sebelah kiri.</p>
            </div>
            <?php else: ?>
