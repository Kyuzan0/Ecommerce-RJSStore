...
<head>
    ...
    <script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','<?= e($ga_id) ?>', { 'debug_mode': true, 'cookie_domain': window.location.hostname, 'cookie_flags': 'SameSite=None;Secure' });</script>
    <?php endif; ?>
